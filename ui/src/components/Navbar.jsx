  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (searchRef.current && !searchRef.current.contains(event.target)) {
        const isSearchItemClick =
          event.target.closest(`.${styles.searchItem}`) ||
          event.target.closest(`.${styles.itemButtons}`) ||
          event.target.closest(`.${styles.counter}`) ||
          event.target.closest(`.${styles.toCart}`);
